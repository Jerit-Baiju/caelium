...
class DirectorySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Directory
        fields = [
            'id', 'name', 'owner', 'owner_details', 'parent', 
...
class FileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'name', 'owner', 'owner_details', 'parent', 
            'created_at', 'modified_at', 'path', 'size', 
            'mime_type', 'file', 'download_url', 'preview_url'
        ]
        read_only_fields = [
            'id', 'created_at', 'modified_at', 'path', 
            'size', 'encryption_key', 'encryption_iv', 'download_url', 'preview_url'
        ]
        extra_kwargs = {
...
class SharedItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SharedItem
        fields = [
            'id', 'user', 'user_details', 'file', 'file_details',
            'directory', 'directory_details', 'permission', 'created_at'
        ]
