...
def encrypt_file_stream(input_file: BinaryIO, output_file: BinaryIO, key: bytes, nonce: bytes) -> int:
    """
...
def decrypt_file_stream(input_file: BinaryIO, output_file: BinaryIO, key: bytes, nonce: bytes) -> int:
    """
